...
class NewsTableViewController: UITableViewController {
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    ...
    case "coolSegue":
      let destination = segue.destination as! CoolViewController
      if let selectedIndex = tableView.indexPathForSelectedRow?.row {
        destination.labelText = "You selected cell #\(selectedIndex)!"
      } else {
        destination.labelText = "Couldn't get selected index :("
      }
